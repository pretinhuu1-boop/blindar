...
PAIRS=(
  ...
  "check-security.sh             | project-python-bad      | project-python-good"
  "check-cryptography.sh         | project-python-bad      | project-python-good"
  "check-cors-csrf.sh            | project-python-bad      | project-python-good"
  ...
  # ─── v0.80: checks operacionais/compliance que passaram de advisory a executados ───
  "check-observability-present.sh | project-obspresent-bad | project-obspresent-good"
  "check-backup-restore-tested.sh | project-restore-bad    | project-restore-good"
  "check-deps-auto-update.sh     | project-autoupdate-bad  | project-autoupdate-good"
  "check-frontend-perf-budget.sh | project-perfbudget-bad  | project-perfbudget-good"
  "check-llm-latency-observability.sh | project-llmlat-bad | project-llmlat-good"
  "check-geo-readiness.sh        | project-geo-bad         | project-geo-good"
  "check-security-headers-completo.sh | project-hdrfull-bad | project-hdrfull-good"
  "check-mfa-readiness.sh        | project-mfa-bad         | project-mfa-good"
  "check-metered-external-cost-guard.sh | project-metered-bad | project-metered-good"
  "check-npm-ci-lockfile.sh      | project-npmci-bad       | project-npmci-good"
  "check-prompt-untrusted-delimiting.sh | project-promptdelim-bad | project-promptdelim-good"
  "check-idempotency-keys.sh     | project-idem-bad        | project-idem-good"
  "check-graceful-shutdown.sh    | project-shutdown-bad    | project-shutdown-good"
  "check-outbound-queue-readiness.sh | project-outq-bad    | project-outq-good"
  "check-container-hardening.sh  | project-container-bad   | project-container-good"
  "check-image-scan.sh           | project-imgscan-bad     | project-imgscan-good"
  "check-pii-in-logs.sh          | project-piilog-bad      | project-piilog-good"
  "check-synthetic-uptime.sh     | project-uptime-bad      | project-uptime-good"
  "check-rollback-ready.sh       | project-rollback-bad    | project-rollback-good"
  "check-image-optimization.sh   | project-imgopt-bad      | project-imgopt-good"
  "check-resource-hints.sh       | project-hints-bad       | project-hints-good"
  "check-a11y-executado.sh       | project-a11yexec-bad    | project-a11yexec-good"
  "check-lgpd-transferencia-internacional.sh | project-transfint-bad | project-transfint-good"
  "check-dsr-automation.sh       | project-dsr-bad         | project-dsr-good"
  "check-retention-job-agendado.sh | project-retencao-bad  | project-retencao-good"
  "check-breach-runbook.sh       | project-breach-bad      | project-breach-good"
  "check-feature-flags-killswitch.sh | project-killswitch-bad | project-killswitch-good"
